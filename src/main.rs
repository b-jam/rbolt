...
struct Header {
    ...
    // Metadata
    last_page_id: u64, //last allocated page
...
impl Header {
    ...
    fn new(page_size: u32) -> Self {
        Header {
            ...
            page_size,
            root_page_id: 0,
            free_list_page_id: 1, // Free list will be on page 1 (the second page)
            last_page_id: 2,      // Data starts from page 2 (the third page)
            tx_id: 0,
        }
    }
}
